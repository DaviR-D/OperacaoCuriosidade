...
function getPageElements(){
    ...
    html.allRegistrations = document.getElementById("allRegistrations");
...
function insertData(html){
    ...
    html.allRegistrations.innerHTML = renderAllRegistrationsHTML().join('');
}

function renderAllRegistrationsHTML(){
