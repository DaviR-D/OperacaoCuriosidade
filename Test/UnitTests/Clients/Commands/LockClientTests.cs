...
namespace Test.UnitTests.Clients.Commands
{
    ...
    {
        [Fact]
        public void Lock_Existing_Unlocked_Client_Test()
        {
            //Arrange
            ...
            //Act
            var result = controller.Lock(clientMockId);
        ...
        [Fact]
        public void Lock_Existing_Locked_Client_Test()
        {
            //Arrange
            ClientMockDependencies mockDependencies = new ClientMockDependencies();
            ClientController controller = mockDependencies.ServiceProvider.GetService<ClientController>();
        ...
        [Fact]
        public void Lock_Deleted_Client_Test()
        {
            //Arrange
            ClientMockDependencies mockDependencies = new ClientMockDependencies();
            ClientController controller = mockDependencies.ServiceProvider.GetService<ClientController>();
        ...
        [Fact]
        public void Lock_Inexistent_Client_Test()
        {
            //Arrange
            ClientMockDependencies mockDependencies = new ClientMockDependencies();
            ClientController controller = mockDependencies.ServiceProvider.GetService<ClientController>();
