...
{
    public class GetSortedClientsTests
    {
        [Fact]
        public void Get_Sorted_Clients_With_Filled_List_Test()
        {
            //Arrange
            ...
            //Act
            var result = controller.GetSortedPage(sortKey: "name", descending: true, start: 0, increment: 10);
        ...
        [Fact]
        public void Get_Sorted_Clients_With_Empty_List_Test()
        {
            //Arrange
            ClientMockDependencies mockDependencies = new();
            ClientController controller = mockDependencies.ServiceProvider.GetService<ClientController>();
            ...
            //Act
            var result = controller.GetSortedPage(sortKey: "date", descending: true, start: 0, increment: 10);
